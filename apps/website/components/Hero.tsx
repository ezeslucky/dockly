...
export function Hero() {
	...
	return (
		<div className="h-[700px] bg-black pt-20 sm:h-[700px] lg:pt-32">
  ...
  {/* Centered Marquee */}
  <div className="relative w-full flex items-center justify-center max-w-[calc(100vw-2rem)] lg:max-w-lg">
    <Marquee className="select-none flex justify-center items-center [--duration:30s] [--gap:2rem]">
